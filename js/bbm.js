          ...
          html += `
            <div class="bg-white rounded-2xl p-4 shadow-xs border border-emerald-100 space-y-3">
              ...
              <div class="grid grid-cols-5 gap-3 text-center text-xs">
                ...
                <div class="bg-emerald-50/60 p-2 rounded-xl"><span class="block text-gray-400 text-[10px] uppercase font-bold">BrazoD</span><span class="font-bold text-gray-800">${registro.Brazo_Der || '-'} cm</span></div>                
                <div class="bg-emerald-50/60 p-2 rounded-xl"><span class="block text-gray-400 text-[10px] uppercase font-bold">BrazoI</span><span class="font-bold text-gray-800">${registro.Brazo_Izq || '-'} cm</span></div>
                <div class="bg-emerald-50/60 p-2 rounded-xl"><span class="block text-gray-400 text-[10px] uppercase font-bold">BrazoD Contr</span><span class="font-bold text-gray-800">${registro.Brazo_Der_Contr || '-'} cm</span></div>
                <div class="bg-emerald-50/60 p-2 rounded-xl"><span class="block text-gray-400 text-[10px] uppercase font-bold">BrazoI Contr</span><span class="font-bold text-gray-800">${registro.Brazo_Izq_Contr || '-'} cm</span></div>
                ...
                <div class="bg-emerald-50/60 p-2 rounded-xl"><span class="block text-gray-400 text-[10px] uppercase font-bold">Muslo SupD</span><span class="font-bold text-gray-800">${registro.Muslo_Sup_Der || '-'} cm</span></div>
                <div class="bg-emerald-50/60 p-2 rounded-xl"><span class="block text-gray-400 text-[10px] uppercase font-bold">Muslo SupI Contr</span><span class="font-bold text-gray-800">${registro.Muslo_Sup_Izq || '-'} cm</span></div>
                <div class="bg-emerald-50/60 p-2 rounded-xl"><span class="block text-gray-400 text-[10px] uppercase font-bold">Muslo MedD</span><span class="font-bold text-gray-800">${registro.Muslo_Med_Der || '-'} cm</span></div>
