          ...
          html += `
            <div class="bg-white rounded-2xl p-4 shadow-xs border border-emerald-100 space-y-3">
              ...
              <div class="grid grid-cols-4 gap-3 text-center text-xs">
                ...
                <div class="bg-emerald-50/60 p-2 rounded-xl"><span class="block text-gray-400 text-[10px] uppercase font-bold">Anteb Der</span><span class="font-bold text-gray-800">${registro.Antebrazo_Der || '-'} cm</span></div>
                <div class="bg-emerald-50/60 p-2 rounded-xl"><span class="block text-gray-400 text-[10px] uppercase font-bold">Anteb Izq</span><span class="font-bold text-gray-800">${registro.Antebrazo_Izq || '-'} cm</span></div>
